...
BAUER GROUP的事件响应流程遵循成熟的NIST SP 800-61框架，并根据§30(2) 第2项 BSIG的要求进行了调整。
...
::: warning 证据保全
在启动任何清理或修复措施之前，务必先保全取证证据。证据对于根本原因分析、监管报告以及可能的执法介入至关重要。
:::
