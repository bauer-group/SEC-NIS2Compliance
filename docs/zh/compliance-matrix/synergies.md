...
| 方面 | NIS2 | CRA | 协同效应 |
|--------|------|-----|----------|
| CVE监控（产品） | —（NIS2引用CRA） | [CRA漏洞管理](https://cra.docs.bauer-group.com/zh/vulnerability-management/) | CRA主导 |
| CVE监控（基础设施） | [漏洞扫描](/zh/vulnerability-management/scanning) | — | NIS2主导 |
| 补丁管理 | [补丁管理](/zh/vulnerability-management/patch-management) | CRA: 产品更新 | 共同期限 |
| 安全开发 | [安全开发](/zh/vulnerability-management/secure-development) | CRA: 安全设计 | 共同开发标准 |
...
| 第7项 -- 培训 | Art. 4（AI素养） | [AI法案培训计划](https://ai-act.docs.bauer-group.com/zh/governance/)作为扩展 |
| 第8项 -- 加密技术 | Art. 15（网络安全） | 加密标准同样适用于AI系统 |
