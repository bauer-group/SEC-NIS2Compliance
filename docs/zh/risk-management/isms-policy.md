...
::: info §38 BSIG – 管理层义务
管理层须实施§30规定的风险管理措施并监督其实施（§38(1) BSIG）；根据立法理由，管理层须事先批准这些措施为适当。违反上述义务的管理层成员须依其实体法律形式适用的公司法，对因过错造成的损害向本实体承担责任（§38(2) BSIG）。此外，管理层须定期参加网络安全培训（§38(3) BSIG）。详情：[管理层职责](/zh/governance/management-duties)。
:::
