...
export default defineConfig({
  ...
  head: [
    ['link', { rel: 'alternate', type: 'application/rss+xml', title: 'NIS2 Compliance (DE)', href: `${baseUrl}/feed-de.xml`, hreflang: 'de' }],
    ['link', { rel: 'alternate', type: 'application/rss+xml', title: 'NIS2 Compliance (EN)', href: `${baseUrl}/feed-en.xml`, hreflang: 'en' }],
    ['link', { rel: 'alternate', type: 'application/rss+xml', title: 'NIS2 Compliance (ZH)', href: `${baseUrl}/feed-zh.xml`, hreflang: 'zh' }],
